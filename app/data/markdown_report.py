...
import logging
import pandas as pd
from vpeleaderboard.src.data.src.basico_model import ModelData
from vpeleaderboard.src.data.utils.markdown import create_markdown, save_markdown
...
def generate_markdown_report(folder_path: str, output_path: str = "docs/data/index.md"):
    ...
    markdown_content = create_markdown(metadata_records, "app/templates", "topic.txt")
...
if __name__ == "__main__":
    ...
    FOLDER_PATH = "vpeleaderboard/src/data/models"  # Folder containing SBML files
