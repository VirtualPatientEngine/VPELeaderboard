...
class BasicoModel(SysBioModel):
    ...
    """
    sbml_file_path: Optional[str] = Field(None, description="Path to an SBML file folder")
    simulation_results: Optional[pd.DataFrame] = Field(None, exclude=True)
    name: Optional[str] = ""
    ...
    def __init__(self, sbml_file_path: Optional[str] = None, name: Optional[str] = "", description: Optional[str] = ""):
        super().__init__(sbml_file_path=sbml_file_path, name=name, description=description)
