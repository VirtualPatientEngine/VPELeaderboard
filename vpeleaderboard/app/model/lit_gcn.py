...
It is a simple Graph Convolutional Network model that consists of two GCN layers.
The first layer takes the node features as input and outputs 16 features.
The final layer takes these 16 features as input and outputs the final output (7).
'''
...
class GCN(LightningModule):
    """Example of a `LightningModule` for GCN
    ...
    def model_step(self,
        ...
        Returns:
            torch.Tensor: The loss between model predictions and targets.
        """
        if mode == 'train':
    ...
    def on_train_epoch_end(self) -> None:
        ...
        Returns:
            None
        """
        print (f'train loss: {self.train_loss.compute()}')
        self.log('train_loss', self.train_loss.compute())

    def validation_step(self,
                        batch: Tuple[torch.Tensor,
                        torch.Tensor], batch_idx: int) -> None:
        """
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        Returns:
            None
        """
        print (f'val loss: {self.val_loss.compute()}')
    ...
    def on_test_epoch_end(self) -> None:
        ...
        Returns:
            None
        """
        print (f'test loss: {self.test_loss.compute()}')
